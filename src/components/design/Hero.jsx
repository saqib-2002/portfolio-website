...
export const Gradient = () => {
  return (
    <>
      <div className="relative z-1 mx-2.5 h-3 rounded-b-[1.25rem] bg-n-11 shadow-xl lg:mx-4 lg:h-3" />
      <div className="relative z-1 mx-6 h-3 rounded-b-[1.25rem] bg-n-11/70 shadow-xl lg:mx-20 lg:h-3" />
    </>
  );
};
...
export const BackgroundCircles = ({ parallaxRef }) => {
  ...
  return (
    <div className="absolute -top-[42.375rem] left-1/2 aspect-square w-[78rem] -translate-x-1/2 rounded-full border border-n-2/5 max-lg:hidden md:-top-[38.5rem] xl:-top-[32rem]">
      <Rings />
