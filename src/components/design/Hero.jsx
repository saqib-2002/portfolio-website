...
export const Gradient = () => {
  return (
    <>
      <div className="relative z-1 h-3 mx-2.5 bg-n-11 shadow-xl rounded-b-[1.25rem] lg:h-3 lg:mx-4" />
      <div className="relative z-1 h-3 mx-6 bg-n-11/70 shadow-xl rounded-b-[1.25rem] lg:h-3 lg:mx-20" />
    </>
  );
};
